    ...
    \begin{longtable}{|L{0.6cm}|c|c|c|c|L{6cm}|}
      \hline
        ...
        \multicolumn{6}{Y{10cm}}{* T$_{DA}$ is
          ...
          a value of at least 80 usec for T$_{DA}$.
        } \\
        \multicolumn{6}{Y{10cm}}{^ T$_{R}$ is claimed in the
          Commodore{\texttrademark} 64 Programmer's Reference Guide to
          have a minimum duration of 20 usec.  We see no evidence that
          would suggest that any drive implementation requires a delay
