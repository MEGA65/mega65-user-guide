    ...
    \begin{longtable}{|L{0.6cm}|c|c|c|c|L{6cm}|}
      \hline
        ...
        \multicolumn{6}{Y{10cm}}{*{}
          ...
          T\textsubscript{V} each have a minimum duration of 20 usec.
          Our investiations suggest that when communicating with a 1541,
          T\textsubscript{ST} must be at least XXX micro seconds,
          T\textsubscript{VT} must be at least XXX micro seconds,
          and
          the sum of T\textsubscript{ST} and T\textsubscript{VT} must
          exceed XXX micro seconds.
        }
          \\
...
\begin{center}
    ...
    \begin{longtable}{|L{0.6cm}|c|c|c|c|L{6cm}|}
      \hline
        ...
        \hline
        \endhead
        \multicolumn{2}{|c|}{T\textsubscript{DA}} & 4/80* & -- & -- &
        Talk-Attention acknowledge hold duration. \\
        \hline
        \multicolumn{2}{|c|}{T\textsubscript{DC}} & 0 & 64 ms & -- & Talk-Attention acknowledge
        duration. {\em Can commence immediately when CLK is observed
        at 5V.}\\
        \hline
        ...
        \multicolumn{6}{Y{10cm}}{\^{} T\textsubscript{R} is claimed in the
          Commodore{\texttrademark} 64 Programmer's Reference Guide to
          have a minimum duration of 20 usec.  We see no evidence that
