...
\begin{enumerate}
  ...
  \item The controller notes if the DATA line was pulled to 0V, and if
    ...
    JiffyDOS{\texttrademark} protcol, and will use this protocol for the
  ...
  \item The controller ensures that the data bit value is visible on
    DATA before asserting CLK, typically 1 -- 4 micro-seconds.
...
\begin{center}
    ...
    \begin{longtable}{|L{0.6cm}|c|c|c|c|L{6cm}|}
      \hline
        ...
        \hline
        \endhead
        \multicolumn{2}{|c|}{T\textsubscript{JD}} & 300  & 300 & $\infty$ &
        ...
        \multicolumn{6}{Y{10cm}}{*{}
          ...
          micro-seconds. However, software implementations of the
          protocol will require a larger value. JiffyDOS\texttrademark
          uses 100 micro-seconds.
        }
