...
\item{\bf Certain keyboard events} Pressing the \specialkey{RESTORE} key for >0.5 seconds, or the \specialkey{ALT} + \specialkey{TAB} key combination traps to the hypervisor.  Typically the first is used to launch the freeze menu an the second to toggle the display of debug interface.
