...
controller to read a sector.  To do this, load the track, sector and
...
XXX - T,S,S max values for DD, HD and ED disks.
XXX - Mapping of 1581 logical sectors to physical disk sectors.
