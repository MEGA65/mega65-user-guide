...
\begin{description}[leftmargin=2cm,style=nextline]
\item [Token:] \$FE \$2E
\item [Format:] {\bf SCREEN width, height, depth} \\
                {\bf SCREEN CLR} \\
                {\bf SCREEN DEF} \\
                {\bf SCREEN SET} \\
...
\item [Usage:] The first version of the {\bf SCREEN} command is the easiest
               ...
               The screen \#0 is opened, initialised and ready to draw to it.
               ...
               The other five versions of the
               {\bf SCREEN} command perform special actions needed for
               advanced graphics programs, that need multiple screens
               or double buffering. They are not needed, if the first version was used.

                {\bf SCREEN CLR colour} clear the active graphics screen
...
\begin{verbatim}
 ...
 20 LINE 25,25,295,175  :REM DRAW LINE
 30 GETKEY A$           :REM WAIT KEYPRESS
 40 SCREEN CLOSE 0      :REM CLOSE SCREEN 0
\end{verbatim}
\end{tcolorbox}
\begin{tcolorbox}[colback=black,coltext=white]
