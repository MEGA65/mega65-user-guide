...
\item [Usage:]
   ...
   {\bf traget bank} = bank number for target

   {\bf sub} = sub command

\item [Remarks:]
The {\bf DMA} controller has access to the whole 16 MB address range
organized in 256 banks of 64 K.
\item [Example:] Using {\bf DMA}
\begin{tcolorbox}[colback=black,coltext=white]
\verbatimfont{\codefont}
\begin{verbatim}
DMA 0, 80*25, 2048, 0, 0, 1  :REM SAVE SCREEN TO $00000 BANK 1
DMA 3, 80*25, 32, 0, 2048, 0 :REM FILL SCREEN WITH BLANKS
DMA 0, 80*25, 0, 1, 2048, 0  :REM RESTORE SCREEN FROM $00000 BANK 1
