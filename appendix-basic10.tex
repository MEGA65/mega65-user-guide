...
\item [Usage:]
   ...
   a string variable in parentheses, e.g. {\bf (FN\$)}.
...
\item [Example:] \screentext{APPEND\#5,"DATA",U9} \\

                 \screentext{APPEND\#130,(\$DD),U(UN\%)} \\

                 \screentext{APPEND\#3,"USER FILE,U"} \\

                 \screentext{APPEND\#2,"DATA BASE"}
