...
\begin{tabular}{|p{2.2cm}r|p{2.2cm}r|p{2.2cm}r|}
\hline
LIST       &   9B &PRINT\#    &   98 &SOUND      &   DA \\
LOAD       &   93 &PUDEF      &   DD &SPC(       &   A6 \\
LOADIFF    & FE43 &RCOLOR     &   CD &SPEED      & FE26 \\
LOG        &   BC &RCURSOR    & FE42 &SPRCOLOR   & FE08 \\
LOG10      & CE08 &READ       &   87 &SPRDEF     & FE1D \\
LOOP       &   EC &RECORD     & FE12 &SPRITE     & FE07 \\
LPEN       & CE04 &REM        &   8F &SPRSAV     & FE16 \\
MEM        & FE23 &RENAME     &   F5 &SQR        &   BA \\
MERGE      &   E6 &RENUMBER   &   F8 &STEP       &   A9 \\
MID\$      &   CA &RESTORE    &   8C &STOP       &   90 \\
MOD        & CE0B &RESUME     &   D6 &STR\$      &   C4 \\
MONITOR    &   FA &RETURN     &   8E &SYS        &   9E \\
MOUSE      & FE3E &RGRAPHIC   &   CC &TAB(       &   A3 \\
MOVSPR     & FE06 &RIGHT\$    &   C9 &TAN        &   C0 \\
NEW        &   A2 &RMOUSE     & FE3F &TEMPO      & FE05 \\
NEXT       &   82 &RND        &   BB &THEN       &   A7 \\
NOT        &   A8 &RPALETTE   & CE0D &TO         &   A4 \\
OFF        & FE24 &RPEN       &   D0 &TRAP       &   D7 \\
ON         &   91 &RREG       & FE09 &TROFF      &   D9 \\
OPEN       &   9F &RSPCOLOR   & CE07 &TRON       &   D8 \\
OR         &   B0 &RSPEED     & CE0E &TYPE       & FE27 \\
PAINT      &   DF &RSPPOS     & CE05 &UNTIL      &   FC \\
PALETTE    & FE34 &RSPRITE    & CE06 &USING      &   FB \\
PASTE      &   E3 &RUN        &   8A &USR        &   B7 \\
PEEK       &   C2 &RWINDOW    & CE09 &VAL        &   C5 \\
PEN        & FE33 &SAVE       &   94 &VERIFY     &   95 \\
PIXEL      & CE0C &SAVEIFF    & FE44 &VIEWPORT   & FE31 \\
PLAY       & FE04 &SCNCLR     &   E8 &VOL        &   DB \\
POINTER    & CE0A &SCRATCH    &   F2 &WAIT       &   92 \\
POKE       &   97 &SCREEN     & FE2E &WHILE      &   FD \\
POLYGON    & FE2F &SET        & FE2D &WINDOW     & FE1A \\
POS        &   B9 &SGN        &   B4 &XOR        &   E9 \\
POT        & CE02 &SIN        &   BF &\string^   &   AE \\
PRINT      &   99 &SLEEP      & FE0B &   &       \\
\hline
\end{tabular}}
% page 1
...
\begin{tabular}{|rp{2.2cm}|rp{2.2cm}|rp{2.2cm}|}
\hline
  EA & HELP       &FE03 & FILTER     &FE27 & TYPE       \\
  EB & DO         &FE04 & PLAY       &FE28 & BVERIFY    \\
  EC & LOOP       &FE05 & TEMPO      &FE29 & ECTORY     \\
  ED & EXIT       &FE06 & MOVSPR     &FE2A & ERASE      \\
  EE & DIR        &FE07 & SPRITE     &FE2B & FIND       \\
  EF & DSAVE      &FE08 & SPRCOLOR   &FE2C & CHANGE     \\
  F0 & DLOAD      &FE09 & RREG       &FE2D & SET        \\
  F1 & HEADER     &FE0A & ENVELOPE   &FE2E & SCREEN     \\
  F2 & SCRATCH    &FE0B & SLEEP      &FE2F & POLYGON    \\
  F3 & COLLECT    &FE0C & CATALOG    &FE30 & ELLIPSE    \\
  F4 & COPY       &FE0D & DOPEN      &FE31 & VIEWPORT   \\
  F5 & RENAME     &FE0E & APPEND     &FE32 & GCOPY      \\
  F6 & BACKUP     &FE0F & DCLOSE     &FE33 & PEN        \\
  F7 & DELETE     &FE10 & BSAVE      &FE34 & PALETTE    \\
  F8 & RENUMBER   &FE11 & BLOAD      &FE35 & DMODE      \\
  F9 & KEY        &FE12 & RECORD     &FE36 & DPAT       \\
  FA & MONITOR    &FE13 & CONCAT     &FE37 & FORMAT     \\
  FB & USING      &FE14 & DVERIFY    &FE38 & GENLOCK    \\
  FC & UNTIL      &FE15 & DCLEAR     &FE39 & FOREGROUND \\
  FD & WHILE      &FE16 & SPRSAV     &FE3B & BACKGROUND \\
CE02 & POT        &FE17 & COLLISION  &FE3C & BORDER     \\
CE03 & BUMP       &FE18 & BEGIN      &FE3D & HIGHLIGHT  \\
CE04 & LPEN       &FE19 & BEND       &FE3E & MOUSE      \\
CE05 & RSPPOS     &FE1A & WINDOW     &FE3F & RMOUSE     \\
CE06 & RSPRITE    &FE1B & BOOT       &FE40 & DISK       \\
CE07 & RSPCOLOR   &FE1C & FREAD\#    &FE41 & CURSOR     \\
CE08 & LOG10      &FE1D & SPRDEF     &FE42 & RCURSOR    \\
CE09 & RWINDOW    &FE1E & FWRITE\#   &FE43 & LOADIFF    \\
CE0A & POINTER    &FE1F & DMA        &FE44 & SAVEIFF    \\
CE0B & MOD        &FE21 & EDMA       &FE45 & EDIT       \\
CE0C & PIXEL      &FE23 & MEM        &FE46 & FONT       \\
CE0D & RPALETTE   &FE24 & OFF        &FE47 & FGOTO      \\
CE0E & RSPEED     &FE25 & FAST       &FE48 & FGOSUB     \\
FE02 & BANK       &FE26 & SPEED      &   &       \\
\hline
\end{tabular}}
...
\end{tcolorbox}
  ...
  asynchronous to your first melody, let's say, using voice2 and voice4 this time.
...
\end{tcolorbox}
  ...
  If you wish to assess whether a melody is playing on a voice channel, presently you can
  find out by checking the value returned from RPLAY(0), which returns a value from 0-63,
  with binary bits 0 to 5 representing whether voice1-6 is playing(1) or not(0).
...
\begin{description}[leftmargin=2cm,style=nextline]
\item [Token:] \$FE \$0F
\item [Format:] {\bf RPLAY(0)}
\item [Usage:] Returns a value from 0 to 63
               with binary bits 0 to 5 representing whether voice1-6
               is playing(1) or not(0).

\item [Example:] Using {\bf RPLAY}:
\begin{tcolorbox}[colback=black,coltext=white]
\verbatimfont{\codefont}
\begin{verbatim}
 10 VO = RPLAY(0) :REM GET STATUS OF 6 VOICES
\end{verbatim}
\end{tcolorbox}
\end{description}
