...
\newpage
\subsection{APPEND}
\currentpdfbookmark{APPEND}{APPEND}
...
\item [Remarks:]
   \screentext{APPEND\#} works similarly to \screentext{DOPEN\#... ,W},
...
\currentpdfbookmark{BACKGROUND}{BACKGROUND}
...
\newpage
\subsection{BACKUP}
\currentpdfbookmark{BACKUP}{BACKUP}
...
\newpage
\subsection{BEGIN}
\currentpdfbookmark{BEGIN}{BEGIN}
...
\newpage
\subsection{BLOAD}
\currentpdfbookmark{BLOAD}{BLOAD}
...
\newpage
\subsection{BORDER}
\currentpdfbookmark{BORDER}{BORDER}
...
\newpage
\subsection{BSAVE}
\currentpdfbookmark{BSAVE}{BSAVE}
...
\newpage
\subsection{BVERIFY}
\currentpdfbookmark{BVERIFY}{BVERIFY}
...
\newpage
\subsection{CATALOG}
\currentpdfbookmark{CATALOG}{CATALOG}
...
\newpage
\subsection{CHANGE}
\currentpdfbookmark{CHANGE}{CHANGE}
...
\newpage
\subsection{CIRCLE}
\currentpdfbookmark{CIRCLE}{CIRCLE}
...
\newpage
\subsection{CLOSE}
\currentpdfbookmark{CLOSE}{CLOSE}
...
\newpage
\subsection{COLLECT}
\currentpdfbookmark{COLLECT}{COLLECT}
...
\currentpdfbookmark{COLLISION}{COLLISION}
...
\newpage
\subsection{COLOR}
\currentpdfbookmark{COLOR}{COLOR}
...
\newpage
\subsection{CONCAT}
\currentpdfbookmark{CONCAT}{CONCAT}
...
\newpage
\subsection{CURSOR}
\currentpdfbookmark{CURSOR}{CURSOR}
...
\newpage
\subsection{DCLEAR}
\currentpdfbookmark{DCLEAR}{DCLEAR}
...
\newpage
\subsection{DCLOSE}
\currentpdfbookmark{DCLOSE}{DCLOSE}
...
\newpage
\subsection{DEF FN}
\currentpdfbookmark{DEF FN}{DEF FN}
\index{BASIC 65 Commands!DEF FN}
\currentpdfbookmark{FN}{FN}
...
\newpage
\subsection{DELETE}
\currentpdfbookmark{DELETE}{DELETE}
...
\newpage
\subsection{DLOAD}
\currentpdfbookmark{DLOAD}{DLOAD}
...
\newpage
\subsection{DMODE}
\currentpdfbookmark{DMODE}{DMODE}
...
\newpage
\subsection{DOPEN}
\currentpdfbookmark{DOPEN}{DOPEN}
\begin{description}[leftmargin=2cm,style=nextline]
\item [Token:] \$FE \$0D
\item [Format:]
...
\newpage
\subsection{DSAVE}
\currentpdfbookmark{DSAVE}{DSAVE}
...
\newpage
\subsection{DVERIFY}
\currentpdfbookmark{DVERIFY}{DVERIFY}
...
\newpage
\subsection{ELLIPSE}
\currentpdfbookmark{ELLIPSE}{ELLIPSE}
...
\newpage
\subsection{ENVELOPE}
\currentpdfbookmark{ENVELOPE}{ENVELOPE}
...
\newpage
\subsection{ERASE}
\currentpdfbookmark{ERASE}{ERASE}
...
\newpage
\subsection{FGOSUB}
\currentpdfbookmark{FGOSUB}{FGOSUB}
...
\newpage
\subsection{FGOTO}
\currentpdfbookmark{FGOTO}{FGOTO}
...
\newpage
\subsection{FILTER}
\currentpdfbookmark{FILTER}{FILTER}
...
\currentpdfbookmark{FOREGROUND}{FOREGROUND}
...
\newpage
\subsection{FREAD}
\currentpdfbookmark{FREAD}{FREAD}
...
\newpage
\subsection{FWRITE}
\currentpdfbookmark{FWRITE}{FWRITE}
...
\newpage
\subsection{GETKEY}
\currentpdfbookmark{GETKEY}{GETKEY}
...
\newpage
\subsection{GOSUB}
\currentpdfbookmark{GOSUB}{GOSUB}
...
\newpage
\subsection{GRAPHIC}
\currentpdfbookmark{GRAPHIC}{GRAPHIC}
...
\newpage
\subsection{HEADER}
\currentpdfbookmark{HEADER}{HEADER}
...
\currentpdfbookmark{HIGHLIGHT}{HIGHLIGHT}
...
\newpage
\subsection{INPUT}
\currentpdfbookmark{INPUT}{INPUT}
...
\newpage
\subsection{INSTR}
\currentpdfbookmark{INSTR}{INSTR}
...
\currentpdfbookmark{LINE INPUT\#}{LINE INPUT\#}
...
\newpage
\subsection{LOADIFF}
\currentpdfbookmark{LOADIFF}{LOADIFF}
...
\newpage
\subsection{LOG10}
\currentpdfbookmark{LOG10}{LOG10}
...
\newpage
\subsection{MERGE}
\currentpdfbookmark{MERGE}{MERGE}
...
\newpage
\subsection{MONITOR}
\currentpdfbookmark{MONITOR}{MONITOR}
...
\newpage
\subsection{MOUSE}
\currentpdfbookmark{MOUSE}{MOUSE}
...
\newpage
\subsection{MOVSPR}
\currentpdfbookmark{MOVSPR}{MOVSPR}
...
\newpage
\subsection{PAINT}
\currentpdfbookmark{PAINT}{PAINT}
...
\newpage
\subsection{PALETTE}
\currentpdfbookmark{PALETTE}{PALETTE}
...
\newpage
\subsection{PEEKW}
\currentpdfbookmark{PEEKW}{PEEKW}
...
\newpage
\subsection{PIXEL}
\currentpdfbookmark{PIXEL}{PIXEL}
...
\newpage
\subsection{POINTER}
\currentpdfbookmark{POINTER}{POINTER}
...
\newpage
\subsection{POKEW}
\currentpdfbookmark{POKEW}{POKEW}
...
\newpage
\subsection{POLYGON}
\currentpdfbookmark{POLYGON}{POLYGON}
...
\newpage
\subsection{PRINT}
\currentpdfbookmark{PRINT}{PRINT}
...
\currentpdfbookmark{PRINT USING}{PRINT USING}
...
\newpage
\subsection{RCOLOR}
\currentpdfbookmark{RCOLOR}{RCOLOR}
...
\newpage
\subsection{RCURSOR}
\currentpdfbookmark{RCURSOR}{RCURSOR}
...
\newpage
\subsection{RECORD}
\currentpdfbookmark{RECORD}{RECORD}
...
\newpage
\subsection{RENAME}
\currentpdfbookmark{RENAME}{RENAME}
...
\newpage
\subsection{RENUMBER}
\currentpdfbookmark{RENUMBER}{RENUMBER}
...
\newpage
\subsection{RESTORE}
\currentpdfbookmark{RESTORE}{RESTORE}
...
\newpage
\subsection{RESUME}
\currentpdfbookmark{RESUME}{RESUME}
...
\newpage
\subsection{RETURN}
\currentpdfbookmark{RETURN}{RETURN}
...
\newpage
\subsection{RGRAPHIC}
\currentpdfbookmark{RGRAPHIC}{RGRAPHIC}
...
\newpage
\subsection{RIGHT\$}
\currentpdfbookmark{RIGHT\$}{RIGHT\$}
...
\newpage
\subsection{RMOUSE}
\currentpdfbookmark{RMOUSE}{RMOUSE}
...
\newpage
\subsection{RPALETTE}
\currentpdfbookmark{RPALETTE}{RPALETTE}
...
\newpage
\subsection{RPLAY}
\currentpdfbookmark{RPLAY}{RPLAY}
...
\newpage
\subsection{RSPCOLOR}
\currentpdfbookmark{RSPCOLOR}{RSPCOLOR}
...
\newpage
\subsection{RSPEED}
\currentpdfbookmark{RSPEED}{RSPEED}
...
\newpage
\subsection{RSPPOS}
\currentpdfbookmark{RSPPOS}{RSPPOS}
...
\newpage
\subsection{RSPRITE}
\currentpdfbookmark{RSPRITE}{RSPRITE}
...
\newpage
\subsection{RWINDOW}
\currentpdfbookmark{RWINDOW}{RWINDOW}
...
\newpage
\subsection{SCNCLR}
\currentpdfbookmark{SCNCLR}{SCNCLR}
...
\newpage
\subsection{SCRATCH}
\currentpdfbookmark{SCRATCH}{SCRATCH}
...
\newpage
\subsection{SCREEN}
\currentpdfbookmark{SCREEN}{SCREEN}
    ...
    \underline{{\bf Simplified approach}}:
        ...
        \underline{{\bf Detailed approach}}:
               ...
               apart from {\bf SCREEN CLOSE}.
                ...
                it will default to 0. Also note that upon closing screen 0,
...
\newpage
\subsection{SLEEP}
\currentpdfbookmark{SLEEP}{SLEEP}
...
\newpage
\subsection{SOUND}
\currentpdfbookmark{SOUND}{SOUND}
...
\newpage
\subsection{SPEED}
\currentpdfbookmark{SPEED}{SPEED}
...
\newpage
\subsection{SPRCOLOR}
\currentpdfbookmark{SPRCOLOR}{SPRCOLOR}
...
\subsection{SPRITE}
\begin{description}[leftmargin=2cm,style=nextline]
\currentpdfbookmark{SPRITE}{SPRITE}
...
\newpage
\subsection{SPRSAV}
\currentpdfbookmark{SPRSAV}{SPRSAV}
...
\newpage
\subsection{TEMPO}
\currentpdfbookmark{TEMPO}{TEMPO}
...
\newpage
\subsection{TROFF}
\currentpdfbookmark{TROFF}{TROFF}
...
\newpage
\subsection{UNTIL}
\currentpdfbookmark{UNTIL}{UNTIL}
...
\newpage
\subsection{USING}
\currentpdfbookmark{USING}{USING}
...
\newpage
\subsection{VERIFY}
\currentpdfbookmark{VERIFY}{VERIFY}
...
\newpage
\subsection{VIEWPORT}
\currentpdfbookmark{VIEWPORT}{VIEWPORT}
...
\item [Remarks:] {\bf VIEWPORT} must be followed by either{\bf CLR} or {\bf DEF}, and four integer parameters.
...
\newpage
\subsection{WHILE}
\currentpdfbookmark{WHILE}{WHILE}
...
\newpage
\subsection{WINDOW}
\currentpdfbookmark{WINDOW}{WINDOW}
