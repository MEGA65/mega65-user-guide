...
\item [Remarks:] {\bf DELETE} is a synonym of {\bf SCRATCH}.
...
\item [Remarks:] {\bf ERASE} is a synonym of {\bf SCRATCH}.
...
\item [Remarks:] {\bf SCRATCH filename} is a synonym of {\bf ERASE}.

                 The success and the number of erased files can
                 be examined by {\bf PRINT}ing or using the system
...
\item [Usage:]  Calls a machine language subroutine.
               ...
               short for {\bf R}e{\bf t}urn from {\bf S}ubroutine. After the subroutine has returned,
