...
{\bf Name} & {\bf Symbol} & {\bf Description} & {\bf Operand type} & {\bf Example}\\
\hline
plus           & +   & addition       & numerical & \screentextwide{A = B + 42}\\
minus          & -   & subtraction    & numerical & \screentextwide{B = A - 42}\\
asterisk       & *   & multiplication & numerical & \screentextwide{C = A * B}\\
slash          & /   & division       & numerical & \screentextwide{D = B / 13}\\
uparrow        & $\uparrow$ & exponentiation & numerical & \screentextwide{E = 2 $\uparrow$ 10}\\
\hline
\end{tabular}
\end{center}
...
\hline
 >   & greater          & numerical & \screentextwide{A > 42}  \\
 >=  & greater or equal & numerical & \screentextwide{B >= 42} \\
 <   & less             & numerical & \screentextwide{A < 42}  \\
 <=  & less    or equal & numerical & \screentextwide{B <= 42} \\
 =   & equal            & numerical & \screentextwide{A = 42}  \\
 <>  & not equal        & numerical & \screentextwide{B <> 42} \\
\hline
\end{tabular}
\end{center}
...
\hline
AND  & and              & logical & \screentextwide{A > 42 AND A < 84} \\
OR   & or               & logical & \screentextwide{A > 42 OR  A = 0} \\
XOR  & exclusive or     & logical & \screentextwide{A > 42 XOR B > 42} \\
NOT  & negation         & logical & \screentextwide{C = NOT A > B} \\
\hline
\end{tabular}
\end{center}
...
{\bf Keyword} & {\bf Description} & {\bf Operand type} & {\bf Example}\\
\hline
AND  & and              & boolean & \screentextwide{A = B AND \$FF} \\
OR   & or               & boolean & \screentextwide{A = B OR \$80} \\
XOR  & exclusive or     & boolean & \screentextwide{A = B XOR 1} \\
NOT  & negation         & boolean & \screentextwide{A = NOT 22} \\
\hline
\end{tabular}
\end{center}
...
{\bf Name} & {\bf Symbol} & {\bf Description} & {\bf Operand type} & {\bf Example}\\
\hline
plus & + & concatenation    & string & \screentextwide{A\$ = B\$ + ".PRG"} \\
\hline
\end{tabular}
\end{center}
