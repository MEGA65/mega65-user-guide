...
\begin{description}[leftmargin=2cm,style=nextline]
\item [Token:] \$FE \$2C
\item [Format:] {\bf CHANGE /findstring/ TO /replacestring/ [,line range]} \\
		{\bf CHANGE "findstring" TO "replacestring" [,line range]}
...
\item [Usage:] Moves the text cursor to
 		...
 		The format without {\bf ON} or {\bf OFF} requires at least one
 		of {\bf column}, {\bf row} or {\bf style}.
%\item [Remarks:]
...
\begin{description}[leftmargin=2cm,style=nextline]
\item [Token:] \$FE \$2B
\item [Format:] {\bf FIND /string/ [,line range]} \\
		{\bf FIND "string" [,line range]}
