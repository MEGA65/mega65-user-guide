...
\item [Format:] {\bf ON expression GOTO line list}  \\
\item [Format:] {\bf ON expression GOSUB line list} \\
\item [Format:] {\bf keyword} {\bf ON}
...
\item [Usage:]  Evaluates the argument list, and prints the values
                ...
                \begin{itemize}
                    ...
                    printed either in fixed point form (typically
                    9 digits), or in scientific form if the value is
...
\item [Usage:]  is used inside a {\bf TRAP} routine to
                ...
                {\bf NEXT} resumes execution at the statement following
                {\bf NEXT} that caused the error.
