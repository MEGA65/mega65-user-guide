...
\item [Remarks:]
               ...
               is different from BASIC 2, where \screentext{ASC("")} gave an error.
...
\item [Usage:] Sets the foreground text colour for subsequent {\bf PRINT} commands.
               ...
               the palette entry numbers and their corresponding colours in the default system palette.
...
\item [Usage:]
   ...
   If the source unit (before TO) is different from the target unit (after TO),
...
\item [Remarks:] After reserving memory with {\bf MEM} the graphics
                 ...
                 banks 4 and 5 and do not honour {\bf MEM} reservations. Such
...
\end{center}
   ...
   a string expression. The syntax is different from {\bf DOPEN\#},
...
\item [Returns:]  The current address of a variable
                ...
                stride. For example, an array dimensioned as \screentext{DIM
                A\%(3,2)} starts at address \screentext{POINTER(A\%(0,0))}, has
...
\item [Returns:] A string of cursor-right PETSCII codes, suitable for printing
