...
40 NEXT X
50 PRINT "COLOR AT POSITION 15: ";C@&(15,2)
\end{screenoutput}
...
\item [Usage:]
   ...
   for resolution and color depth.
...
\end{center}
  ...
  The modulation directive modulates your note by the magnitude you
  specify (1-9), or use 0 to not use it.
