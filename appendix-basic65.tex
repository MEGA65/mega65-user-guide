...
\item [Usage:]  Displays text on a graphic screen.
                ...
                start position of the output in horizontal direction.
                ...
                in vertical direction. In contrast to the column parameter,
                ...
                1st. part \$xx000 -> \$xx7FF : upper case / graphics

                2nd. part \$xx800 -> \$xxFFF : lower case / upper case
...
\item [Remarks:]
                ...
                different units in x and y direction:
                x is in [columns] and y in [pixel].
...
\item [Usage:] {\bf CLR} with no parameters Resets all pointers, that
               ...
               So all variables and arrays are undeclared.
