...
In the statement \screentextwide{A * A - B * B}
...
\begin{tabular}{|l|l|l|l|}
\hline
{\bf Symbol} & {\bf Description} & {\bf Operand type} & {\bf Examples}\\
\hline
 =   & assignment & all & \screentextwide{A = 42, A\$ ="HELLO", A = B < 42}\\
\hline
\end{tabular}
\end{center}
...
\hline
plus  & +   & positive sign & numerical & \screentextwide{A = +42} \\
minus & -   & negative sign & numerical & \screentextwide{B = -42} \\
\hline
\end{tabular}
\end{center}
...
{\bf Name} & {\bf Symbol} & {\bf Description} & {\bf Operand type} & {\bf Example}\\
\hline
Plus           & \screentextwide{+}   & addition       & numerical & \screentextwide{A = B + 42}\\
Minus          & \screentextwide{-}   & subtraction    & numerical & \screentextwide{B = A - 42}\\
Asterisk       & \screentextwide{*}   & multiplication & numerical & \screentextwide{C = A * B}\\
Slash          & \screentextwide{/}   & division       & numerical & \screentextwide{D = B / 13}\\
Up Arrow       & \screentextwide{$\uparrow$} & exponentiation & numerical & \screentextwide{E = 2 $\uparrow$ 10}\\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{|l|l|l|l|}
\hline
{\bf Symbol} & {\bf Description} & {\bf Operand type} & {\bf Example}\\
\hline
\screentextwide{>}  & greater          & numerical & \screentextwide{A > 42}  \\
\screentextwide{>=} & greater or equal & numerical & \screentextwide{B >= 42} \\
\screentextwide{<}  & less             & numerical & \screentextwide{A < 42}  \\
\screentextwide{<=} & less    or equal & numerical & \screentextwide{B <= 42} \\
\screentextwide{=}  & equal            & numerical & \screentextwide{A = 42}  \\
\screentextwide{<>} & not equal        & numerical & \screentextwide{B <> 42} \\
\hline
\end{tabular}
\end{center}
...
\begin{tabular}{|l|l|l|l|}
\hline
{\bf Keyword} & {\bf Description} & {\bf Operand type} & {\bf Example}\\
\hline
\screentextwide{AND}  & and              & logical & \screentextwide{A > 42 AND A < 84} \\
\screentextwide{OR}   & or               & logical & \screentextwide{A > 42 OR  A = 0} \\
\screentextwide{XOR}  & exclusive or     & logical & \screentextwide{A > 42 XOR B > 42} \\
\screentextwide{NOT}  & negation         & logical & \screentextwide{C = NOT A > B} \\
\hline
\end{tabular}
\end{center}
...
{\bf Keyword} & {\bf Description} & {\bf Operand type} & {\bf Example}\\
\hline
\screentextwide{AND}  & and              & boolean & \screentextwide{A = B AND \$FF} \\
\screentextwide{OR}   & or               & boolean & \screentextwide{A = B OR \$80} \\
\screentextwide{XOR}  & exclusive or     & boolean & \screentextwide{A = B XOR 1} \\
\screentextwide{NOT}  & negation         & boolean & \screentextwide{A = NOT 22} \\
\hline
\end{tabular}
\end{center}
...
{\bf Name} & {\bf Symbol} & {\bf Description} & {\bf Operand type} & {\bf Example}\\
\hline
Plus & \screentextwide{+} & Concatenates strings & string & \screentextwide{A\$ = B\$ + ".PRG"} \\
\hline
\end{tabular}
\end{center}
...
\hline
High & \screentextwide{$\uparrow$} \\
& \screentextwide{+ -} signs \\ %is this needed here with the +- 2 lines below?
& \screentextwide{* /} \\
& \screentextwide{+ -} \\
& \screentextwide{< <= > >= = <>} \\
& \screentextwide{NOT} \\
& \screentextwide{AND} \\
Low & \screentextwide{OR XOR}\\
\hline
\end{tabular}
\end{center}
...
{\bf Unit}  & {\bf Device} \\
\hline
\screentextwide{0}    & Keyboard \\
\screentextwide{1}    & System Default \\
\screentextwide{2}    & RS232 Serial Connection \\
\screentextwide{3}    & Screen \\
\screentextwide{4-7}  & IEC Printer and Plotter \\
\screentextwide{8-31} & IEC Disk Drives \\
\hline
\end{tabular}
}
\end{center}
