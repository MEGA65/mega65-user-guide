...
\end{tcolorbox}
  ...
  with binary bits 0 to 5 representing whether voice1-6 is playing(1) or not(0). Note that
  there are plans to move this behaviour to a new RPLAY command in future.
