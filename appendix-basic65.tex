...
\item \includegraphics[width=0.8\linewidth]{images/find-example.png}
\end{description}
...
\item \includegraphics[width=0.7\linewidth]{images/foreground-example.png}
\end{description}
...
\item [Remarks:] The new {\bf line} number will be searched by scanning
               ...
               By knowing this mechanism, it is possible to optimise
...
\item \includegraphics[width=0.8\linewidth]{images/highlight-example.png}
\end{description}
...
\item [Remarks:] The user must take care to enter the correct
               ...
               of variables.
               Entering nonnumerical characters for integer or real
               variables will produce a TYPE MISMATCH ERROR.
               Strings for string variables must be in quotes
               if they contain spaces or commas. \\
               Many programs that need a safe input routine use
               {\bf LINE INPUT} and use an custom parser, in order
...
\item [Usage:]
   ...
   After pressing \specialkey{RETURN}, the listed file will be loaded.
