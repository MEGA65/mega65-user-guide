...
\item [Usage:] Sets the background colour
               ...
               customisable via the {\bf PALETTE} command, though on
               startup, the ROM provides the first 32 preset colours
               described in the colour table below.
...
\item [Usage:] Sets the border colour
               ...
               customisable via the {\bf PALETTE} command, though on
               startup, the ROM provides the first 32 preset colours
               described in the colour table under {\bf BACKGROUND}
...
\item [Usage:] Evaluates numeric expression as line number
               and calls the subroutine at that number.

\item [Warning:] Using this feature can break the program, if {\bf RENUMBER}
                 is applied, because line numbers may change and the
                 numeric expression doesn't address the correct line numbers
                 anymore.
