...
\label{sec:screen-memory-and-colour-ram}
...
\bookvref{cha:dmagic}
\fi
   for the powerful possibilities with EDMA.
   ...
   also helpful for in-place memory displacing. Please see the example below.
...
\end{tcolorbox}
   ...
   By adding 32 (bit 5) to the command memory content can be inserted
   in reverse order:
