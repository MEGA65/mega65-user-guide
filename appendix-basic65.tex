...
\item [Usage:] Used to renumber all, or
               ...
               or optimisation mode. The optimisation mode removes space
               characters before linenumbers, such reducing code size
               and decreasing execution time, while the space conserving
               mode does what it says. Optimisation mode is triggered
               by typing the first argument, the new starting number,
               adjacent to the keyword {\bf RENUMBER} with no space
               between.
