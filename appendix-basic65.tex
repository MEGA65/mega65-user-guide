...
\item [Usage:]    Prints a series of values formatted to the current output stream, typically the screen.
                  ...
                  \begin{itemize}
                     ...
                     \item '{\bf ;}'; Semicolon separates arguments of the list. It does not print any characters. A semicolon at the end of the argument list suppresses the automatic return (carriage return) character.
                     \item '{\bf ,}': Comma moves the cursor to the next tab position.
                 \end{itemize}
...
\item [Remarks:]  The argument must not be negative. If {\bf SRQ()} is given a negative value, it throws an Illegal Quantity error.
