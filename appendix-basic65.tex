...
\item [Usage:] Terminates the definition
               ...
               {\bf end} used at the end of an iteration,
...
\item [Token:] \$9F
\item [Format:]
  {\bf OPEN channel, first address [,secondary address [,filename]]}
\item [Usage:]
...
\item [Remarks:] The format string is applied for one argument only,
                 ...
                 {\bf USING format;argument} sequence.
...
\item [Remarks:] The row and column start at zero, where
...
\item [Usage:]  Positions the read/write pointer of a relative file.
               ...
               Any call of {\bf INPUT\#} or {\bf PRINT\#} will proceed
               on the selected record position.

\item [Remarks:] The original Commodore disk drives had a bug
...
\item [Usage:]  Marks any characters after {\bf REM} on the same line as a comment.
                ...
                Characters after {\bf REM} are never executed, but skipped.
...
\item [Usage:] Used to renumber all, or
               ...
               {\bf new } The new starting line of the
               line range to renumber.
               The default value is 10.

               {\bf inc } The increment to be used.
               The default value is 10.

               {\bf range } The line range to renumber.
...
\item [Usage:]  Set, or reset the internal pointer for
                ...
                {\bf line} The new position for the
...
\item [Usage:] Returns a value of 0 or 1, to indicate whether a melody is playing on the given voice channel or not.
...
\item [Remarks:] The register values after a {\bf SYS} call are stored
                 ...
                 {\bf RREG} is able to retrieve these values.
...
\item [Usage:]  Returns multi-colour sprite colours.
                ...
                {\bf n} the sprint colour to retrieve. Must be either 1, or 2.
