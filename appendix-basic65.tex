...
\item [Remarks:] There is no terminating character in BASIC 65 (some languages, such as C
                 use the NULL character). The length of
                 the string is internally stored in a byte
                 within the string descriptor.
...
\item [Usage:] The {\bf MOD} function returns the remainder of the
      division.
\item [Remarks:] In other programming languages such C and Java, this function
...
\item [Usage:] Terminates the definition
               ...
               The {\bf end} value is used at the end of an iteration,
