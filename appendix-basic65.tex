...
The table below describes what the other symbols found in this appendix mean.
...
\begin{center}
    ...
    \begin{longtable}{|c|L{8cm}|}
        ...
        You can also choose no option by omitting it. \\
        \hline
        \{ , \} &
...
which starts in bank 1 at address \$F6FF, and expand \textit{downwards}.
