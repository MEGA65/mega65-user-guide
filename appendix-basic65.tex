...
\item [Usage:] Sets the border colour
               of the screen to the argument, which must be in the
               range of 0 to 15. (See colour table under the {\bf BACKGROUND} command on page \pageref{colourtable}).
...
\item [Usage:] Sets the foreground colour
               ...
               range of 0 to 15.
(See colour table under the {\bf BACKGROUND} command on
page \pageref{colourtable}).
\item [Example:] Using {\bf FOREGROUND}
\begin{center}
\includegraphics[width=0.7\linewidth]{images/foreground-7.png}
\end{center}
