...
64 Variables are predefined as {\bf fast} variables.
These are the one-letter variables (A - Z), (A\% - Z\%) and (A\$ - L\$).
...
variables, either use or definition, is much faster, than the access to other
variables. The address has not to be searched in a table, but is
computed by a very fast algorithm.
