...
The size for real items is 5, so the data of that array occupy 540 bytes.
...
\item [Usage:] The first form of the {\bf BOX} command with
               ...
               draws a simple rectangle, assuming, that he
               coordinate pairs declare two diagonal opposite corners.
