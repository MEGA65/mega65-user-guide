...
\newpage
\section{Hyppo Services Quick Reference}

The following is a quick reference for the Hyppo services. See the full reference for details and examples.

\begin{longtable}{|L{4cm}|p{1.5cm}|L{1.5cm}|L{1.5cm}|L{4cm}|}
\hline
\textbf{hyppo Name} & \textbf{Category} & \textbf{Input} & \textbf{STA} & \textbf{Description} \\
\hline
\endfirsthead
...
\hline
\endhead
\multicolumn{5}{l@{}}{continued \ldots}\\
\endfoot
\hline
\endlastfoot

geterrorcode & General & A=\$38 & \$D640 & Current error code from Hyppo \\
\hline
getversion & General & A=\$00 & \$D640 & Version of Hyppo, HDOS \\
\hline
setup\_transfer\_area & General & A=\$3A, Y & \$D640 & Sets up the area Hyppo uses to transfer data \\
\hline
chdir & SD card & A=\$0C & \$D640 & Changes the current working directory \\
\hline
cdrootdir & SD card & A=\$3C, X & \$D640 & selectdrive then set current working directory to root \\
\hline
closeall & SD card & A=\$22 & \$D640 & Closes all file descriptors \\
\hline
closedir & SD card & A=\$16, X & \$D640 & Closes a file descriptor for a directory \\
\hline
closefile & SD card & A=\$20, X & \$D640 & Closes a file descriptor for a file \\
\hline
filedate & SD card & A=\$2C & \$D640 & Not implemented \\
\hline
findfile & SD card & A=\$34 & \$D640 & Finds the first file whose filename matches the current Hyppo filename \\
\hline
findfirst & SD card & A=\$30 & \$D640 & Finds the first file whose filename matches the current Hyppo filename \\
\hline
findnext & SD card & A=\$32 & \$D640 & Finds a subsequent file whose filename matches the current Hyppo filename \\
\hline
fstat & SD card & A=\$28 & \$D640 & Not implemented \\
\hline
getcurrentdrive & SD card & A=\$04 & \$D640 & The number of the currently selected SD card partition \\
\hline
getcwd & SD card & A=\$0A & \$D640 & Not implemented \\
\hline
getdefaultdrive & SD card & A=\$02 & \$D640 & The SD card partition Hyppo selected while booting \\
\hline
getdrivesize & SD card & A=\$08 & \$D640 & Not implemented \\
\hline
loadfile & SD card & A=\$36, XYZ & \$D640 & Loads a file into chip memory \\
\hline
loadfile\_attic & SD card & A=\$3E, XYZ & \$D640 & Loads a file into hyper memory \\
\hline
mkdir & SD card & A=\$0E & \$D640 & Not implemented \\
\hline
mkfile & SD card & A=\$1E & \$D640 & Not implemented \\
\hline
opendir & SD card & A=\$12 & \$D640 & Opens the current working directory for reading the file entries in it \\
\hline
openfile & SD card & A=\$18 & \$D640 & Opens a file on a drive \\
\hline
readdir & SD card & A=\$14, XY & \$D640 & Reads the next FAT dir entry into a destination area \\
\hline
readfile & SD card & A=\$1A & \$D640 & Reads the next sector of the current file into the sector buffer \\
\hline
rename & SD card & A=\$2A & \$D640 & Not implemented \\
\hline
rmdir & SD card & A=\$10 & \$D640 & Not implemented \\
\hline
rmfile & SD card & A=\$26 & \$D640 & Removes a file \\
\hline
seekfile & SD card & A=\$24 & \$D640 & Not implemented \\
\hline
selectdrive & SD card & A=\$06, X & \$D640 & Sets the currently selected SD card partition \\
\hline
setname & SD card & A=\$2E, Y & \$D640 & Sets the current Hyppo filename \\
\hline
writefile & SD card & A=\$1C & \$D640 & Writes the sector buffer to the current file \\
\hline
attach & Disk image & A=\$4A, X & \$D640 & Attach or detach a disk image to the virtualised F011 drive \\
\hline
d81attach0 & Disk image & A=\$40 & \$D640 & Deprecated \\
\hline
d81attach1 & Disk image & A=\$46 & \$D640 & Deprecated \\
\hline
d81detach & Disk image & A=\$42 & \$D640 & Deprecated \\
\hline
d81write\_en & Disk image & A=\$44 & \$D640 & Enables writing to any disk images attached to virtualised F011 drives 0 and 1 \\
\hline
create\_task\_c64 & Task & A=\$66 & \$D640 & Not implemented \\
\hline
create\_task\_c65 & Task & A=\$68 & \$D640 & Not implemented \\
\hline
create\_task\_native & Task & A=\$62 & \$D640 & Not implemented \\
\hline
exit\_and\_switch\_to\_task & Task & A=\$6A & \$D640 & Not implemented \\
\hline
exit\_task & Task & A=\$6E & \$D640 & Not implemented \\
\hline
get\_mapping & Task & A=\$74 & \$D640 & Copies the current 45GS02 memory mapping into a destination area \\
\hline
get\_proc\_desc & Task & A=\$58 & \$D640 & Copies the current task block into a destination area \\
\hline
gettasklist & Task & A=\$50 & \$D640 & Not implemented \\
\hline
load\_into\_task & Task & A=\$64 & \$D640 & Not implemented \\
\hline
readoutoftask & Task & A=\$58 & \$D640 & Not implemented \\
\hline
receivemessage & Task & A=\$54 & \$D640 & Not implemented \\
\hline
reset & Task & A=\$7E & \$D640 & Warm boots the MEGA65 \\
\hline
rom\_writeenable & Task & A=\$02 & \$D641 & Enables writing to banks 2 and 3 \\
\hline
rom\_writeprotect & Task & A=\$00 & \$D641 & Disables writing to banks 2 and 3 \\
\hline
sendmessage & Task & A=\$52 & \$D640 & Not implemented \\
\hline
\makecell[l]{serial\_monitor\_wait \\ \_and\_write} & Task & A=byte & \$D643 & Waits for the serial debugger to be ready, writes a character to it \\
\hline
serial\_monitor\_write & Task & A=\$7C, Y=byte & \$D640 & Writes a character to serial debugger, without waiting \\
\hline
set\_mapping & Task & A=\$76, Y & \$D640 & Copies the source area into the current 45GS02 memory mapping \\
\hline
switch\_to\_task & Task & A=\$6C & \$D640 & Not implemented \\
\hline
terminateothertask & Task & A=\$60 & \$D640 & Not implemented \\
\hline
toggle\_force\_4502 & Task & A=\$72 & \$D640 & Toggles the CPU personality between 45GS02 and 6502 \\
\hline
toggle\_rom\_writeprotect & Task & A=\$70 & \$D640 & Toggles write protection of banks 2 and 3 \\
\hline
writeintotask & Task & A=\$56 & \$D640 & Not implemented \\
\hline
configsector\_apply & Config & A=\$04 & \$D642 & Applies the system configuration sector currently loaded into memory \\
\hline
configsector\_read & Config  & A=\$00 & \$D642 & Reads the system configuration sector into memory \\
\hline
configsector\_write & Config & A=\$02 & \$D642 & Writes the system configuration sector from memory \\
\hline
dmagic\_autoset & Config & A=\$06 & \$D642 & Sets the DMAgic revision based on the loaded ROM \\
\hline
freeze\_self & Freezer & A=any & \$D67F & Launches the freezer \\
\hline
get\_slot\_count & Freezer & A=\$16 & \$D642 & Gets the number of freeze slots \\
\hline
locate\_freeze\_slot & Freezer & A=\$10 & \$D642 & Locates the first sector of a freeze slot \\
\hline
read\_freeze\_region\_list & Freezer & A=\$14 & \$D642 & Reads the freeze region list \\
\hline
unfreeze\_from\_slot & Freezer & A=\$12 & \$D642 & Unfreezes from a freeze slot \\
\hline
\end{longtable}
...
\item [Remarks:]
  ...
  \hypporef{attach} to attach the disk image and then use either use the KERNAL
...
\item [Preconditions:]
  There is a current file open. Files can be opened with \hypporef{openfile}.
\item [Postconditions:]
  The next call to \hypporef{writefile} will write the next sector of the current
  file.
\item [Errors:]
  \errordesc{89}{invalid file descriptor}{There is no current file.}
\item [History:]
...
\item [Preconditions:]
  (attach) The current Hyppo filename has been set using \hypporef{setname}.
\item [Inputs:]
  \register{X.0}{Select drive 0 or 1.}
  \register{X.1}{With X.0=1, select both drives (detach only).}
  \register{X.6}{Do not reattach real drives (detach only).}
  \register{X.7}{Mode of operation: 0=attach, 1=detach.}
\item [Errors:]
  \errordesc{81}{name to long}{The name of the disk image is to long for the
  process descriptor (max 31 chars).}
  \errordesc{88}{file not found}{The disk image file was not found in the
  current directory of the current drive.}
  \errordesc{8A}{image wrong length}{The length of the image does not fit any
  of the supported image types.}
  \errordesc{8B}{image fragmented}{The data of the image is not in one continuous
  sequence of sectors, this is unsupported.}
  \errordesc{8F}{double attach}{The requested image is already attached to the
  other drive.}
\item [History:]
  \availablefrom{1.3}
\item [Remarks:]
...
\item [History:]
  \availablefrom{1.2}\\
  \deprecatedfrominstead{1.3}{attach}
\item [Remarks:]
  This actually calls \hypporef{attach} with \register{X}{= \$00}
\end{hyppotrap}
...
\item [History:]
  ...
  \deprecatedfrominstead{1.3}{attach}
\item [Remarks:]
  This actually calls \hypporef{attach} with \register{X}{= \$01}
\end{hyppotrap}
...
\item [History:]
  ...
  \deprecatedfrominstead{1.3}{attach}
\item [Remarks:]
  This actually calls \hypporef{attach} with \register{X}{= \$C2}
\end{hyppotrap}
