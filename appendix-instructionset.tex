...
NOTE: Check if your assembler supports this addressing mode.
...
NOTE: Most 6502 unintended opcodes are currently unimplemented and even 
those implemented are not guaranteed to produce the same effect as
a real 6502 processor.
...
The unintended instructions are currently unimplemented, and are guaranteed
