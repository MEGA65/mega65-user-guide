...
clrch = $ffcc
    ...
    lda #$01
    jsr close
    jsr clrch    ; clear I/O channels after closing the file
    \end{asmcode}
\end{description}
...
\begin{description}[leftmargin=2cm,style=nextline]
    ...
    \item [Remarks:]
        ...
        When used with a disk drive, SAVE only saves a file of type PRG. To save a file of another type, use SETNAM with the type mentioned in the name string (such as \textt{"MYFILE,S"} for a SEQ file), along with OPEN, CKOUT, BSOUT, and CLOSE. See OPEN for an example.
