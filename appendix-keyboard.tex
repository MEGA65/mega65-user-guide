...
held down.  The \specialkey{RESTORE} key exists outside of the keyboard matrix, as on the C64.  To simulate
holding the \specialkey{RESTORE} key down, write \$52 (ASCII code for a capital R), and to simulate a quick tap
of the \specialkey{RESTORE}, write \$72 (ASCII code for a lower-case R).  Another value must be written after the
\$72 value has been written, if you wish to simulate multiple presses of the \specialkey{RESTORE} key.
