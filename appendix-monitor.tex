...
This is not a full assembler like you might use to write large programs. In particular, it does not support symbols, such as labels for subroutines or kernel addresses. Instead of {\ttfamily {\bf JSR CHROUT}}, you must look up the address of {\ttfamily {\bf CHROUT}} and enter the number value: {\ttfamily {\bf JSR FFD2}}
...
{\em Note: Instructions involving the Q virtual register are not yet supported.}
