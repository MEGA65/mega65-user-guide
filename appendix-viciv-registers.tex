...
\small Colour RAM byte 0, bit 4 - 7 & {\small RESERVED, set to 0 }\\
\small Colour RAM byte 0, bit 4 & {\small GOTO X, set to 1 }\\
\small Colour RAM byte 0, bits 3 & {\small RESERVED, set to 0  }\\
...
\small Colour RAM byte 1, bits 0 - 7 & {\small RESERVED, set to 0 }\\
\end{longtable}
...
To do this, each character now requires 64 bytes of data. The address of the data is 64 $\times$ the character number.  FCM should
