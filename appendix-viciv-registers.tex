...
20 IF PEEK(53272)<32 THEN POKE53295,ASC("G"):POKE53295,ASC("S")
30 REM CHECK NTSC BIT
40 NTSC=PEEK(53359) AND 128
...
90 IF A$="Y" THEN POKE53359,PEEK(53359) XOR 128:ELSE END
100 REM DISPLAY NEW STATE
110 NTSC=PEEK(53359) AND 128
