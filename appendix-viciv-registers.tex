...
It can be disabled by clearing the HOTREG signal (bit2040 7 of \$D05D, 53341 decimal).
...
\begin{screenoutput}
10 AD=$0E00: REM $0E00 SPRITE
20 REM C65/C64 MODE DETECT
30 IF PEEK($D018) AND 32 THEN GOTO 100
40 POKE $D02F,ASC("G"):POKE $D02F,ASC("S"): REM ENABLE MEGA65 VIC-IV FEATURES
100 REM CLEAR SPRITE
110 FOR I=AD TO AD+168:POKE I,0:NEXT I
120 POKE $ff8,AD/64: REM SET SPRITE NUMBER
130 POKE 53269,1:    REM ENABLE SPRITE 0
140 POKE 53248,100:  REM PUT SPRITE
150 POKE 53249,100:  REM ON SCREEN
160 POKE 53355,1:    REM MAKE SPRITE 0 16-COLOUR
170 POKE 53335,1:    REM MAKE SPRITE 0 USE 64 BITS OF DATA = 16 X 4-BIT PIXELS
180 POKE 53287,10:   REM MAKE COLOUR 10 TRANSPARENT
190 GOSUB 900:       REM READ MULTI-COLOUR SPRITE
200 END
...
2000 DATA "JJJJJJJJJJJJJJJJ"
2010 DATA "JJJJJJJJJJJJJJJJ"
2020 DATA "JJJJJJJJJJJJJJJJ"
2030 DATA "JJJJJJ@@@JJJJJJJ"
2040 DATA "JJJJ@@GGG@@JJJJJ"
...
2160 DATA "JJJJ@@GGG@@JJJJJ"
2170 DATA "JJJJJJ@@@JJJJJJJ"
2180 DATA "JJJJJJJJJJJJJJJJ"
2190 DATA "JJJJJJJJJJJJJJJJ"
2200 DATA "JJJJJJJJJJJJJJJJ"
2210 DATA "END"
\end{screenoutput}
