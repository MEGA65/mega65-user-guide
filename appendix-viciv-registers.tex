...
To improve compatibility, the VIC-IV also signals when a ``bad line'' would have occurred on the VIC-II.  The 45GS02 processor
of the MEGA65 accepts these bad line strobes and pauses the CPU for 40 ~1MHz clock cycles, except if the processor is running
...
depending on the insstruction being executed at the time.
