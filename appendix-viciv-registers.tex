...
120 FOR I=AD TO AD+168:POKE I,0:NEXT
130 POKE $ff8,AD/64: REM SET SPRITE NUMBER
140 POKE 53269,1:    REM ENABLE SPRITE 0
150 POKE 53248,100:  REM PUT SPRITE
160 POKE 53249,100:  REM ON SCREEN
170 POKE 53355,1:    REM MAKE SPRITE 0 16-COLOUR
180 POKE 53335,1:    REM MAKE SPRITE 0 USE 64 BITS OF DATA = 16 X 4-BIT PIXELS
190 POKE 53287,10:   REM MAKE COLOUR 10 TRANSPARENT
200 GOSUB 900:       REM READ MULTI-COLOUR SPRITE
210 END
