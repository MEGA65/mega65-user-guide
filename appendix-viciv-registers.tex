...
of the MEGA65 accepts these bad line signals, and pauses the CPU for 40 ~1MHz clock cycles, except if the processor is running
...
depending on the insstruction being executed at the time. Also, the VIC-IV and 45GS02 do not currently pause for sprite fetches.
