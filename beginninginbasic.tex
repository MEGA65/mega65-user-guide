...
knows that you mean \sceentextwide{PRINT}.  So for example if you type \screentextwide{? N}, it will do the same as typing
...
So if you type \screentextwide{1 ? N}, and then \screentypewide{LIST}, you will see \screentextwide{1 PRINT N}, as we can see
