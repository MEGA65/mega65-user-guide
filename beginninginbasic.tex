...
\setlength{\intextsep}{0pt}%
  ...
  Clue: You will need to modify the \screentext{FOR} command.  

  \subsubsubsection{Can you change the counting step?)
    ...
    Clue: You will need to modify the \screentext{STEP} clause of the \screentext{FOR} command.\index{STEP}\index{BASIC10 Commands!STEP}
    

    \subsubsubsection{Can you make it print out one of the times tables?)
      ...
      \subsubsubsection{Can you make it print out the times tables from 1$\times$1 to 10$\times$10?)

        Clue: You might like to use ; on the end of \screentext{PRINT} statements, so that you can have
        more than one entry per line on the screen.
        Clue: The \screentext{PRINT} statement without any argument will just advance to the start of the next line.
        Clue: You might need to have multiple \screentext{FOR} loops, one inside the other.
