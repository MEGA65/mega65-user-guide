...
can have more than one \stw{INPUT} and \stw{PRINT} statement.}
...
\stw{IF} statement that has a true statement were executed. The rest
...
using the \stw{IF} statement and an appropriate relative operator to
