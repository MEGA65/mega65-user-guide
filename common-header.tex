...
\usepackage[bookmarks=true,linktoc=uncolored]{hyperref}
\hypersetup{
  colorlinks   = true, %Colours links instead of ugly boxes
  urlcolor     = blue, %Colour for external hyperlinks
  % Internal links cannot be blue, because other wise section headings on
  % blue intro pages will be invisible as blue-on-blue
