...
First, turn the MEGA65 on while holding down the \megakey{ALT} key.
...
It's recommended to perform regular backups of the data on
...
Here, you can select and test you screen configuration. For example, press \megakey{TAB} to switch to PAL 50Hz.
...
Next, press \megakey{K} to keep the new video mode.

\begin{center}
  \includegraphics[width=\linewidth]{images/img011_final_boot_04.jpg}
\end{center}

Finally, press \megakey{RETURN} to complete the configuration.
...
If you come across this error message, you will need to use the \megakey{F7} key to save the reset configuration, otherwise
...
\begin{minipage}{\linewidth}
  When you are happy with the settings, you can press \megakey{F7} to show the
