...
formatting process.
The default ROM however is read from the file MEGA65.ROM, which contains
...
features of the MEGA65 and are incomplete and buggy, because the development
was stopped, before these C65 ROMs could be completed.
