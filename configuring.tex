...
the MEGA65 FDISK/FORMAT utility (which is called \screentextwide{SDCARD FDISK+FORMAT UTILITY} in the screenshot above),
...
\begin{itemize}
  ...
  \item \screentext{LONG FN SUPPORT} is a facility that is still under development
    at time of writing, and we suggest leaving it disabled for now until the facility
