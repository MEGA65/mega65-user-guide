...
\begin{enumerate}
  ...
  \item Open the Freezer: press and hold \widekey{RESTORE} for one second then release.
  \item Press \specialkey{HELP}. The ``MEGA65 Information'' utility opens.
\end{enumerate}
