...
\item If Flash Slot 0 is being used, it then checks if \specialkey{NO SCROLL} is being held.
\item If it is, the Flash Menu program shows its display, allowing you to select or re-flash a core.
\item If \specialkey{NO SCROLL} is not being pressed, the Flash Menu program checks if Flash Slot 1 contains a valid
      core.
