...
i.e., turn off the power, hold the \specialkey{NO SCROLL} key down while turning the power on.  When the flash
...
press \megakey{CTRL} and \megakey{2} to \megakey{3} from the flash and core menu, so that the core
