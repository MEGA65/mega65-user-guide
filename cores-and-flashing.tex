...
\begin{center}
  \begin{longtable}{|C{2.5cm}|C{2cm}|C{2cm}|C{2cm}|C{2cm}|}
    ...
    \hhline{|=|=|=|=|=|}
    \multirow{2}{*}{\textbf{MEGA65R3b}} & \multicolumn{4}{l|}{The retail/release version of the MEGA65} \\
      \cline{2-5}
      & A200T & 64MB & 8 & 8MB \\
    \hhline{|=|=|=|=|=|}
    \multirow{2}{*}{\textbf{MEGA65R3a}} & \multicolumn{4}{l|}{The DevKit model} \\
      \cline{2-5}
      & A200T & 32MB & 4 & 8MB \\
    \hhline{|=|=|=|=|=|}
