...
The MEGA65 motherboard has 4 DIP switches (at position S3 on the PCB), some of which impact flashing and booting behaviour, so they are documented below:

\begin{center}
  \begin{longtable}{|C{1.5cm}|p{10cm}|}
    \hline
    ...
    \hline
    2 & {
        Off = Enable audio on digital video connection \newline
        On = Disable audio on digital video connection
    } \\
    \hline
    3 & {
