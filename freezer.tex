...
The Freezer is invoked by long pressing \widekey{RESTORE}.
...
In the screenshot below, the  \screentextwide{MEGA65.D81} file has been mounted to drive 0:
...
\index{BASIC 65 Commands!BACKGROUND!Examples}
\index{BASIC 65 Commands!BORDER!Examples}
\index{BASIC 65 Commands!LOAD!Examples}
\index{BASIC 65 Commands!SAVE!Examples}
