...
\begin{appendices}
  ...
  %% TODO: The build fails when there are more than 26 appendices. The %
  %% \AlphAlph numbering should have fixed this, and the failed build does %
  %% produce a working PDF with Appendix AA as the 27th appendix.
  %%
  %% This is the 27th appendix added, so it is commented out for now until
  %% this issue is fixed.
  %%
  ...
  %% TODO: Another appendix pending the appendix numbering fix.
