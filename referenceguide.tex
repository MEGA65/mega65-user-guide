     ...
     \begin{center}
       {
         ...
         \vspace*{2cm}
             ...
             \vspace{\fill}
                    {\textcolor{white}{Published by \\ the MEGA Museum of Electronic Games and Art, Germany.}}
       }
     \end{center}
   \end{titlepage}
...
% Then the copyright notice page
  ...
  \index{copyright}Copyright \copyright 2018 -- 2021 by Paul Gardner-Stephen, the Museum of Electronic Games and Art eV., and contributors.
