...
Hi there, congratulations for now owning a MEGA65! This sheet contains important and useful information to get you started -- don't throw it away and do not eat it!

More information is available at \url{https://mega65.org} with links to many additional resources.  New games, software and updates are provided through Filehost at \url{https://files.mega65.org}. After registration, redeem the code below to get access to additional content. Your personal code, which should not be shared with any third party, is:
...
Join the community chat for real time conversations at \url{https://mega65.org/chat} and the official forum at \url{https://mega65.org/forum}.

We wish you lots of fun and creativity using your MEGA65! \\
