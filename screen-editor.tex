...
Long press on \specialkey{RESTORE} to go into the Freeze Menu.  Then press \megakey{J} to switch joystick ports without having to physically swap the joystick to the other port.

Go to \textbf{Fast mode} with poke 0, 65 or use the freeze menu.

\megakey{MEGA} and \specialkey{SHIFT} switches between text uppercase and lowercase for the entire display.
