...
You can also produce reverse text or colour bars by holding down the \megakey{CTRL} key and pressing the \megakey{9} key or the \megakey{0} key. These combinations enable and disable  the reverse text mode.
...
You can disable the reverse text mode by holding \megakey{CTRL} and pressing the \megakey{0} key again.
