...
There are a further eight colours available via the \megasymbolkey key. Hold the \megasymbolkey key and press a key from \megakey{1} to \megakey{8} to change to one of the secondary colours. For even more colours, see \bookvref{appendix:escapesequences}.
...
You can see all the available \bookvref{appendix:escapesequences}. We will cover some examples of these shortly.
