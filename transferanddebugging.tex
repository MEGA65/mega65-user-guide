...
The \stw{b65support.bin} file will then be available in the \stw{bin65} folder.
...
After loading, \stw{b65support.bin} is initialised with

\begin{screencode}
    SYS $1600
\end{screencode}

Once initialised, the following functions are provided by \stw{b65support.bin}:
