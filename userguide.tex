...
\declaretocfmt{section*}{\@F{\Large\bfseries\hspace{4cm}\textbullet\hspace{1em}}\@B{1.5em}\@P{\mtocgobble}}
\end{minitocfmt}
...
\newcommand*{\justifyheading}{\raggedleft}
\titleformat{\chapter}[display]
            {\emptypage\thispagestyle{plain}\pagecolor{blue}\textcolor{white}\normalfont\huge\bfseries\justifyheading}
            {\chaptertitlename\ \thechapter}
            {20pt}
            {\Huge}[\bluemtoc\insertminitoc
              \newpage\pagecolor{white}\textcolor{white}\emptypage
            ]
