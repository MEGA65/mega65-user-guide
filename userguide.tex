...
\cleardoublepage
\pagecolor{blue}
\title{\bf\textcolor{white}{MEGA65 USER'S GUIDE}}

% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{Published by \\ the Museum of Electronic Games and Art (M.E.G.A.) eV, Germany.\\and\\Flinders University, Australia.}
\date{\today}
% make the title area
  \maketitle
