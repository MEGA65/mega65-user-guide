...
\titleformat{\part}[display]
   ...
   {\Huge\textcolor{white}}
   [\pagecolor{white}\textcolor{black}]
%  [\textcolor{white}{\partmtoc\insertminitoc}\newpage\newpage\pagecolor{white}\textcolor{black}]
...
\titleformat{\chapter}[display]
   {\thispagestyle{empty}\pagecolor{blue}\normalfont\huge\bfseries\justifyheading}
   {\textcolor{white}{\uppercase \chaptertitlename \quad{\fontsize{100}{130}\selectfont \bf\thechapter}}}
   {20pt}
   {\Huge\textcolor{white}}
   [\textcolor{white}{\chapmtoc\insertminitoc}\newpage\pagecolor{white}]
