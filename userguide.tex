...
\declaretocfmt{section}{\@F{\Large\bfseries\hspace{4cm}\textcolor{white}\textbullet\hspace{1em}}\@B{1.5em}\@P{\mtocgobble}}
\declaretocfmt{section*}{\@F{\Large\bfseries\hspace{4cm}\textcolor{white}\textbullet\hspace{1em}}\@B{1.5em}\@P{\mtocgobble}}
\declaretocfmt{chapter}{\@F{\Large\bfseries\hspace{4cm}\textcolor{white}\textbullet\hspace{1em}}\@B{1.5em}\@P{\mtocgobble}}
\declaretocfmt{chapter*}{\@F{\Large\bfseries\hspace{4cm}\textcolor{white}\textbullet\hspace{1em}}\@B{1.5em}\@P{\mtocgobble}}
\end{minitocfmt}
...
\titleformat{\chapter}[display]
  {\thispagestyle{empty}\pagecolor{blue}\normalfont\huge\bfseries\justifyheading}{\textcolor{white}{\chaptertitlename\ \Huge{\thechapter}}}
  {20pt}{\Huge\textcolor{white}}[\textcolor{white}\bluemtoc\insertminitoc\newpage\newpage\pagecolor{white}\textcolor{black}]
...
\titleformat{\chapter}[display]
            {\clearpage\thispagestyle{plain}\pagecolor{blue}\textcolor{white}\normalfont\huge\bfseries\justifyheading}
            {\chaptertitlename\ {\Huge\thechapter}}
            {20pt}
            {\Huge\textcolor{white}}[\textcolor{white}\bluemtoc\insertminitoc
              \newpage\pagecolor{white}\textcolor{black}\clearpage
            ]
